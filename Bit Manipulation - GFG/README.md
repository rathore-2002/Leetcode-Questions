...
<span style="font-size:18px"><strong>Explanation: </strong>Bit at the 3rd position from LSB is 0. (1 0 0 0 <strong>1</strong> 1 0)</span>
...
<span style="font-size:18px">The value of the given number after setting the 3rd bit is 9. (1 0 0 <strong>1</strong>)</span>
<span style="font-size:18px">The value of the given number after clearing 3rd bit is 66. (1 0 0 <strong>0</strong>)</span></pre>
